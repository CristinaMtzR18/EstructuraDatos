/*
    ...
    Este programa registra la asistencia de 3 estudiantes durante 3 días.
    Utiliza una matriz donde las filas representan estudiantes y las columnas
    representan días.
...
int main() {
    // Matriz de 3 estudiantes por 3 dias
    int asistencia[3][3];

    cout << "TABLA DE ASISTENCIA" << endl;
    ...
    // Sumar asistencias por estudiante
    for (int estudiante = 0; estudiante < 3; estudiante++) {
        int total = 0;
